...
import { $$node_sid, IAddChildrenNextSiblingPayload, IAddChildrenPrevSiblingPayload, IAddNextSiblingNodesPayload, IAddPreviousSiblingNodesPayload, IMoveNextSiblingNodePayload, IMovePreviousSiblingNodePayload, IMoveToChildrenNodePayload, INode, IRemoveNodePayload, IRemoveNodesPayload, ITree } from '../../../interfaces/entity/ITree';

export abstract class AbsTree<TNode extends INode<TNode>> extends Disposable implements ITree<TNode> {
    ...
    abstract addNextSiblingNodes(payload: IAddNextSiblingNodesPayload<TNode>): void;
    abstract addPreviousSiblingNodes(payload: IAddPreviousSiblingNodesPayload<TNode>): void;
    ...
    abstract movePreviousSiblingNode(payload: IMovePreviousSiblingNodePayload): void
