...
export declare abstract class Shape<TClassData extends ENTITY_DATA, TStyleData extends ENTITY_DATA, TAttributeData extends ENTITY_DATA> {
    ...
    get draw(): IShapeDrawLifecycle<TClassData, TStyleData, TAttributeData>;
    set draw(value: IShapeDrawLifecycle<TClassData, TStyleData, TAttributeData>);
    get move(): IShapeMoveLifecycle;
    set move(value: IShapeMoveLifecycle);
    get resize(): IShapeResizeLifecycle;
    set resize(value: IShapeResizeLifecycle);
}
